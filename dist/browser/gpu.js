...
exports.GPU_ARGS = void 0;
exports.isGpuEnabled = isGpuEnabled;
exports.isBridgeGpuEnabled = isBridgeGpuEnabled;
exports.gpuChannel = gpuChannel;
exports.logWebglRenderer = logWebglRenderer;
/**
 ...
 * (scanner vs bridge).
 */
async function logWebglRenderer(page, log) {
    try {
        ...
        if (renderer === null) {
            log.warn(`WebGL renderer probe timed out after ${RENDERER_PROBE_TIMEOUT_MS} ms. ` +
        ...
        if (/swiftshader|llvmpipe|software|no-webgl/i.test(renderer)) {
            log.warn(`GPU mode ON but WebGL is NOT on the iGPU: "${renderer}". ` +
