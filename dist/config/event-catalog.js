...
exports.getEventDef = getEventDef;
exports.getEventCatalogSummary = getEventCatalogSummary;
exports.EVENT_CATALOG = [
    {
        key: 'ancients',
        name: 'Ancients',
        order: 1,
        description: 'Rise of the Ancients — Vault of the Ancients kills plus the Tinman event rewards.',
        columnMode: 'chest',
        showLevelCard: true,
    ...
    },
    {
        ...
        name: 'Triumphal',
        order: 5,
        description: 'Union Chest — Gold Pass rewards and store purchases, in rolling 30-day cycles.',
        columnMode: 'chest',
        showLevelCard: false,
...
function getEventDef(key) {
    return exports.EVENT_CATALOG.find((e) => e.key === key);
}
/** Catalog trimmed to what the sub-tab bar needs, ordered. */
function getEventCatalogSummary() {
    return [...exports.EVENT_CATALOG]
