...
exports.gameDayUtcOffsetHours = gameDayUtcOffsetHours;
exports.gameDayTimezoneId = gameDayTimezoneId;
exports.expectedBrowserTimezoneOffsetMinutes = expectedBrowserTimezoneOffsetMinutes;
exports.zoneOffsetMinutesBehindUtc = zoneOffsetMinutesBehindUtc;
/**
 ...
 */
function gameDayUtcOffsetHours(rolloverUtcHour) {
 ...
 * string.
 */
function gameDayTimezoneId(rolloverUtcHour) {
 ...
 */
function expectedBrowserTimezoneOffsetMinutes(rolloverUtcHour) {
 ...
 */
function zoneOffsetMinutesBehindUtc(timeZone, now = new Date()) {
...
//# sourceMappingURL=game-timezone.js.map