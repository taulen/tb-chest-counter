...
exports.MAX_DIGEST_RECIPIENTS = void 0;
exports.parseDigestRecipients = parseDigestRecipients;
exports.normalizeDigestRecipients = normalizeDigestRecipients;
...
function parseDigestRecipients(raw) {
    ...
    for (const piece of String(raw).split(/[\s,;]+/)) {
        ...
        if (out.includes(id))
            continue;
        out.push(id);
        if (out.length >= exports.MAX_DIGEST_RECIPIENTS)
            break;
    }
    return out;
}
 ...
 */
function normalizeDigestRecipients(raw) {
    return parseDigestRecipients(raw).join(', ');
}
//# sourceMappingURL=digest-recipients.js.map