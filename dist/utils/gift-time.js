...
exports.GIFT_LIFETIME_MS = void 0;
exports.giftEarnedAtMs = giftEarnedAtMs;
/** Fixed starting lifetime of every gift's claim window. */
exports.GIFT_LIFETIME_MS = 20 * 60 * 60 * 1000;
/**
 ...
 */
function giftEarnedAtMs(timeLeft, screenshotMs, fallbackMs = screenshotMs) {
    if (!Number.isFinite(screenshotMs))
        return fallbackMs;
    ...
    if (m) {
        ...
        if (hours <= 20 && mins <= 59) {
            ...
            if (remainingMs > 0 && remainingMs <= exports.GIFT_LIFETIME_MS) {
                return screenshotMs + remainingMs - exports.GIFT_LIFETIME_MS;
            }
        }
    }
    return fallbackMs;
}
//# sourceMappingURL=gift-time.js.map